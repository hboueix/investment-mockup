...
import { IonContent, IonHeader, IonPage, IonTitle, IonButton, IonToolbar, IonInput, IonItem, IonLabel, IonImg, IonCard, IonList, IonSegment, IonSegmentButton, IonItemDivider } from '@ionic/react';
